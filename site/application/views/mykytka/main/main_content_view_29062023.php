                        ...
                        <div class="card-body">
                            ...
                            <div class="main-wrap-8-block-2">
                                   ...
                                   <a 
                                    ...
                                    data-sum="<?=$vc['dop1'];?>"
                                    data-id="<?=$vc['dop3'];?>"
                                    class="btn-get-pdf pt-2 pb-2 ps-2 pe-2 mb-0" href="#">
                                   ...
                                   <div class="d-inline-block w-100 mt-1">
                                    ...
                                    class="btn w-100 btn-get-pdf-2" href="#">
                                              ...
                                              <div class="row">
                                                     ...
                                                     <div class="col-9 btn bg-color-red text-white 
                                                           fa-1x pt-4 pr-4">
                                                      <?php if (!empty($buttons['12_title'])) echo htmlspecialchars_decode($buttons['12_title']); // У <strong>PDF</strong> ФОРМАТІ     ?> 
                                                     </div>
                                              </div> 
                                       </a>     
                                      </div>
