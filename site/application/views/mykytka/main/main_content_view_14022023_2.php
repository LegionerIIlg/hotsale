    ...
    <div class="container">
        <div class="main-wrap-8-block">
            ...
            <div class="row d-flex justify-content-between mt-1 mt-md-5">
                <div class="col-4 col-sm-4 main-wrap-8-block-img-inner1">
                    ...
                    <div class="card w-100 bg-transparent border-0">
                        <img class="card-img-top" 
                             ...
                             src="<?= $img_ob1; ?>">
                        <div class="card-body">
                            <h5 class=" card-title p-summ"><?php if (!empty($payosht_b['42_title'])) echo $payosht_b['42_title']; //   149 "   ?> <span class="span-small"><?php if (!empty($buttons['13_name'])) echo $buttons['13_name']; // ГРН.     ?></span></h5>
                ...
                <div class="col-4 col-sm-4 main-wrap-8-block-img-inner3 ">  

                    <div class="card w-100 bg-transparent border-0">
                        <img  class="card-img-top"
                              alt="<?= $title_ob2; ?>"                                                                                 title="<?= $title_ob2; ?>"                                                                               src="<?= $img_ob3; ?>">
                        <div class="card-body">
                            <h5 class=" card-title p-summ"> <?php if (!empty($payosht_b['44_title'])) echo $payosht_b['44_title']; //   299 "   ?> <span class="span-small"><?php if (!empty($buttons['13_name'])) echo $buttons['13_name']; // ГРН.     ?></span></h5>
                            <div class="main-wrap-8-block-2">
                                <a 
                ...
                <div class="col-4 col-sm-4 main-wrap-8-block-img-inner2">
                    <div class="card w-100 bg-transparent border-0">
                        <img class="card-img-top" 
                             alt="<?= $title_ob2; ?>"
                             title="<?= $title_ob2; ?>"
                             src="<?= $img_ob2; ?>">
                        <div class="card-body">
                            <h5 class=" card-title p-summ"> <?php if (!empty($payosht_b['43_title'])) echo $payosht_b['43_title']; //   199"   ?> 

                                <span class="span-small"><?php if (!empty($buttons['13_name'])) echo $buttons['13_name']; // ГРН.     ?></span></h5>
                            <div class="main-wrap-8-block-2">
                                <a 
