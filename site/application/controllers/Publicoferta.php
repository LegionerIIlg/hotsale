...
class Publicoferta extends CI_Controller {
        ...
        public function index()
	{
            ...
            $d['page'] =   $this->buttons_model->select_one_page(36, $this->nowLanguge);
         ...
         private function  getMain(){
             ...
             // $d['buttons_about']=$this->buttons_model->select_in_buttons(8,$this->nowLanguge);
              ...
              $d['about_comics'] = $this->buttons_model->select_table_in_pages(26, $this->nowLanguge);
               $d['about'] =   $this->buttons_model->select_one_page(36, $this->nowLanguge);
